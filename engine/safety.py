...
# ═══════════════════════════════════════════════════════════════════
CARDIAC_KEYWORDS = [
    "ألم في الصدر", "ألم الصدر", "وجع في الصدر",
    "ضيق في التنفس", "ضيق التنفس", "صعوبة في التنفس",
    "تعرق غزير", "تعرق شديد",
    "ألم في الذراع", "ألم الذراع", "وجع الذراع",
    "غثيان مفاجئ", "إغماء", "دوار شديد",
    "خفقان شديد", "نبض سريع جداً",
]
